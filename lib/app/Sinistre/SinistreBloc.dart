import 'package:flusa/app/Sinistre/SinTry.dart';
import 'package:flutter/material.dart';

class SinistreBloc extends StatefulWidget {
  const SinistreBloc({super.key});

  @override
  State<SinistreBloc> createState() => _SinistreBlocState();
}

class _SinistreBlocState extends State<SinistreBloc> {
  int _currentStep = 0;
